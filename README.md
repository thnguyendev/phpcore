...
This example desmonstrates how your PHPWebCore app work with databases. We use RedBeanPHP and SQLite because it is so easy to included to your app. Just make sure you have SQLite enabled in "php.ini" (extension=pdo_sqlite and extension=sqlite3).
