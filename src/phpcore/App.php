<?php
    ...
    class App implements AppInterface{
        ...
        public function __construct() {
            ...
            $this->getService("phpcore\\RequestService")->redirectToNoTrailingSlash();
        }

        public function process() {
            try {
                $this->getService("phpcore\\RouteService")->mapController();
            }
        ...
        public function enableCors($origins = "", $methods = "", $headers = "") {
            $requestService = $this->getService("phpcore\\RequestService");
